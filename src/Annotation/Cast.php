...
final class Cast implements Transformation
{
    ...
    private function validate(mixed $value): void
    {
        ...
        throw new InvalidArgumentException(sprintf('Only %s %s accepted, %s (%s) given.', implode(' and ', array_map(static fn (PhpType $type) => $type->getName(), $this->types)), count($this->types) === 1 ? 'is' : 'are', $other->getName(), var_export($value, true)));
    }
